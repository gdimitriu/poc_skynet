...
*/
package org.gdimitriu.skynet.utils;
...
public final class IOUtils {
	...
	/**
	 * transform an input string into InputStream.
	 * @param str as input string
	 * @return InputStream that correspond to input string.
	 */
	public static InputStream transformStringToInputStream(final String str) {
