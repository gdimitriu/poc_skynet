...
*/
package org.gdimitriu.skynet.services.interfaces;

import java.util.List;

public interface IRunnableService extends IService{

	void start();
	void stop();
	
	IRunnableService getInstance();
	
	@Override
	default void upgrade(final List<?> listOfClassesToUpgrade) {
